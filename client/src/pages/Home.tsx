  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {[
                ...
                >
                  <h3 className="text-2xl font-medium text-gray-900 mb-6">{item.title}</h3>
                  <div className="w-full bg-gray-50 rounded-xl p-6 border border-dashed border-gray-200">
                    <div className="text-5xl font-normal text-primary mb-1">{item.metric}</div>
        ...
        {/* CTA Bottom */}
        <section className="py-24 bg-gradient-to-br from-indigo-50 via-indigo-100 to-indigo-200 text-gray-900 relative overflow-hidden">
           {/* Background decoration */}
           <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-indigo-200/30 rounded-full blur-3xl translate-x-1/3 -translate-y-1/3" />
           <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-indigo-300/20 rounded-full blur-3xl -translate-x-1/3 translate-y-1/3" />
           
           <div className="container mx-auto px-4 relative z-10 text-center">
             <h2 className="text-5xl md:text-7xl font-serif font-normal mb-8 text-gray-900">I'm almost ready for my first official day.</h2>
             <p className="text-gray-700 max-w-2xl mx-auto mb-10 text-xl">
               Be one of the first 50 businesses to hire me. I'll take care of your calls. You take care of your customers.
             </p>
             <div className="flex flex-col sm:flex-row justify-center gap-4">
               <button className="text-white px-8 py-4 rounded-full font-bold shadow-lg hover:shadow-xl transition-all transform hover:scale-105" style={{ background: 'linear-gradient(180deg, rgba(219, 108, 241, 1) 30%, rgba(234, 115, 218, 1) 100%)', borderColor: 'rgba(230, 230, 230, 1)' }}>
                 Join My Waitlist
               </button>
             </div>
           </div>
